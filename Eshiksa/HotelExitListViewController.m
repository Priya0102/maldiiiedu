...
#import "Constant.h"
#import "HotelExitListTableViewCell.h"
#import "HotelExitList.h"
#import "BaseViewController.h"
#import "Base.h"
@interface HotelExitListViewController ()

@end

@implementation HotelExitListViewController
...
//                [self.view addSubview:_noSchedule];
                ...
                UIAlertController *alertView = [UIAlertController alertControllerWithTitle:@"Sorry!" message:@"Currently there is no hotel exit data." preferredStyle:UIAlertControllerStyleAlert];
            ...
            for(NSDictionary *temp in ciculararr)
            {
                ...
                HotelExitList *k1=[[HotelExitList alloc]init];
...
{
    HotelExitListTableViewCell *cell = [_tableview dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
    
    HotelExitList *ktemp=[_remarkArr objectAtIndex:indexPath.row];
